...
export default function Contact() {
  ...
  const mapQuery = encodeURIComponent(`${HOME_LAT},${HOME_LNG}`);
...
Message: ${message}
  ...
  return (
    ...
    >
      <Seo
        title="Contact | Baxtiyorov Shaxriyor"
        description="Get in touch with Baxtiyorov Shaxriyor for frontend development work, freelance collaboration, and project opportunities."
      />
      ...
      >
        ...
        >
          <div className="flex items-start justify-between gap-4">
            <div>
              <h2 id="contact-location" className="text-xl font-semibold">
                {data.about.name}
              </h2>
      ...
      <motion.section className="mt-8" variants={item}>
